THREE.TrackballControls = function (object, domElement) {
    ...
    this.getMouseProjectionOnBall = (function () {
        ...
        return function (pageX, pageY, projection) {
            mouseOnBall.set((pageX - _this.screen.width * 0.5 - _this.screen.left) / (_this.screen.width * 0.5), (_this.screen.height * 0.5 + _this.screen.top - pageY) / (_this.screen.height * 0.5), 0);
    ...
    function keydown(event) {
        ...
        if (_state !== STATE.NONE) {
            ...
            if (event.keyCode === _this.keys[STATE.ROTATE] && !_this.noRotate) {
                ...
                if (event.keyCode === _this.keys[STATE.ZOOM] && !_this.noZoom) {
                    _state = STATE.ZOOM
                } else {
