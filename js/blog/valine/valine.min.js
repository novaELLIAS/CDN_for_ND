        ...
        */
        ...
        r.prototype.init = function (e) {
            ...
            try {
                ...
                if (n && r && t.installLocale(n, r), t.locale = t.locale || g[n || "zh-cn"], t.notify = c || !1, t.verify = d || !1, w) {
                    ...
                    S.parentNode.insertBefore(O, S), window.getIP = function (e) {
                        v.ip = e.ip
                    }
                }
                m.params = "?d=" + (_.indexOf(i) > -1 ? i : "mp") + "&v=" + o + A, m.hide = "hide" === i, m.cdn = h.test(l) ? l : m.cdn, y = e.path || y;
                var $ = Number(x || 10);
                ...
                for (var M = u.findAll(document, ".valine-comment-count"), L = 0, T = M.length; L < T; L++) ! function (e, n) {
                    var r = M[e];
                    if (r) {
                ...
                t.el = z, t.el.classList.add("v"), m.hide && t.el.classList.add("hide-avatar"), e.meta = (e.guest_info || e.meta || b).filter(function (e) {
                ...
                t.placeholder = e.placeholder || "Just Go Go", t.el.innerHTML = '<div class="vwrap"><div class="vheader item' + B.length + '">' + B.join("") + '</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + t.placeholder + '"></textarea><div class="vctrl"><span class="vemoji-btn">' + t.locale.ctrl.emoji + '</span> | <span class="vpreview-btn">' + t.locale.ctrl.preview + '</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v' + o + "</div></div>";
                var j = u.find(t.el, ".vempty");
                t.nodata = {
                    show: function (e) {
                        return j.innerHTML = e || t.locale.tips.sofa, u.attr(j, "style", "display:block;"), t
                    },
                    hide: function () {
                        return u.attr(j, "style", "display:none;"), t
                    }
                };
                ...
                t.loading = {
                    show: function (e) {
                        ...
                        return e ? P.insertBefore(I, n[0]) : P.appendChild(I), t.nodata.hide(), t
                    },
                    hide: function () {
                        var e = u.find(P, ".vloading");
                        return e && u.remove(e), 0 === u.findAll(P, ".vcard").length && t.nodata.show(), t
                    }
                };
                ...
                t.alert = {
                    show: function (e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), u.on("click", u.find(U, ".vcancel"), function (e) {
                                t.alert.hide()
                    ...
                    hide: function () {
                        return u.attr(U, "style", "display:none;"), t
                    }
                }, t.bind(e)
            } catch (e) {
                t.ErrorHandler(e)
        ...
        r.prototype.Q = function (e) {
            ...
            t.emoji = {
                ...
                show: function () {
                    return v.comment && (t.emoji.hide(), u.attr(o, "v", 1), u.removeAttr(i, "v"), r.innerHTML = v.comment, u.attr(r, "style", "display:block"), T()), t.preview
                },
                hide: function () {
